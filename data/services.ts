export const services = [
  ...
  },
  {
    ...
    question: "Why get the service?",
    answer:
      "As time passes, your investment’s paint job becomes subjected to wear & tear including improper washing & drying techniques, UV rays, and harsh environment climates. All of these factors can cause anything from dull paint to swirls, scratches, and flaking clear coat. With paint correction, it’s a guaranteed way to restore your vehicle’s paint.",
    subheading1: "Benefits of Paint Correction",
    subheading1description: "Here are the undeniable benefits:",
    benefits: [
      {
        title: "Restored Paint Job",
        description:
          "Removal of swirls, pigtails, scratches, water spots, and even oxidation to reveal your vehicle’s true color and shine.",
      },
      {
        title: "Enhanced Appearance",
        description:
          "With the elimination of those visual defects and the contamination that mar your vehicle’s paint, the appearance of your vehicle’s paint is enhanced with the depth of its shine, clarity, and gloss. All of these create that showroom finish that your vehicle was always meant to have.",
      },
      {
        title: "Increased Value",
        description:
          "A well-maintained and detailed vehicle is more likely to retain its finish, which can significantly enhance the resale value of your vehicle.",
      },
    ],
    process: [
      {
        title: "Vehicle Inspection",
        description:
          "I conduct a thorough inspection of your vehicle’s paintwork, identifying specific imperfections along with determining (and recommending) what kind of paint correction service it needs.",
      },
      {
        title: "Paint Decontamination",
        description:
          "I start by thoroughly washing the vehicle along with decontaminating the surface to remove any dirt, grime, or residues that may interfere with the correction process (include bird waste and insect guts,).",
      },
      {
        title: "Machine Polishing",
        description:
          "IUsing professional tools and techniques, I carefully machine polish the paintwork, progressively removing defects and restoring the finish. I employ various abrasive compounds and pads, tailoring our approach to your vehicle’s specific needs.",
      },
      {
        title: "Finishing Touches",
        description:
          "Once the correction process is complete, I refine the paintwork further with fine polishing compounds and finishing products to maximize gloss and clarity.",
      },
      {
        title: "Protective Measures",
        description:
          "To preserve and extend the results of the paint correction, I can apply a high-quality ceramic coating, sealant or wax to protect the newly restored paint from future damage and maintain its brilliance.",
      },
    ],
  },
  {
    ...
    question: "Why get the service?",
    answer:
      "Ceramic coatings are the introduction to long-lasting paint protection. This innovative technology forms a strong and durable bond with the surface of your vehicle, creating a protective layer that shields it from various environmental elements. ",
    subheading1: "Benefits of Ceramic Coating",
    subheading1description:
      "Here’s why ceramic coatings are a popular choice among car enthusiasts:",
    benefits: [
      {
        title: "Unmatched Protection",
        description:
          "ceramic coatings provide an effective barrier against UV rays, oxidation, bird droppings, tree sap, water spots, chemical stains, and other contaminants that can damage your vehicle’s paintwork.",
      },
      {
        title: "Superior Gloss and Shine",
        description:
          "The advanced formula of ceramic coatings gives your vehicle a deep, glossy finish that enhances its appearance, making it look brand new for years to come.",
      },
      {
        title: "Ease of Maintenance",
        description:
          "Say goodbye to frequent waxing and polishing. Ceramic coatings make your vehicle easier to clean by preventing dirt, grime, and other debris from sticking to the surface. A simple wash is all it takes to maintain that showroom shine.",
      },
      {
        title: "Long-Lasting Results",
        description:
          "Unlike traditional wax or sealant products, ceramic coatings offer long-term protection. With proper care, ceramic coatings can last for several years, saving you time and money in the long run.",
      },
    ],
    process: [
      {
        title: "Vehicle Inspection",
        description:
          " I begin by thoroughly inspecting your vehicle’s paintwork to identify any imperfections, scratches, or swirl marks that need to be addressed before applying the ceramic coating.",
      },
      {
        title: "Paint Correction",
        description:
          "f necessary, I perform paint correction to remove minor scratches, swirl marks, and other surface defects. This step ensures a smooth and flawless finish.",
      },
      {
        title: "Surface Preparation",
        description:
          "I clean and decontaminate the vehicle’s surface to remove any dirt, grease, or residues that may interfere with the bonding of the ceramic coating.",
      },
      {
        title: "Ceramic Coating Application",
        description:
          "As a skilled technician, I apply the ceramic coating using professional techniques, ensuring even coverage and maximum protection.",
      },
      {
